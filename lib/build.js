...
function build () {
  return new Promise((resolve, reject) => {
    ...
    this.options.webpack && this.options.webpack.plugins && (config.plugins = config.plugins.concat(this.options.webpack.plugins))
    ...
    config.plugins.push(new DependsPlugin({
