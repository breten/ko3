...
function build () {
  return new Promise((resolve, reject) => {
    ...
    config.entry = _.defaultsDeep(getEntries([entryGlob, entryGlobPlus], this.options.pagesDir), getEntries([entryHtmlGlob], this.options.pagesDir, this.options.tmpDir),config.entry)
